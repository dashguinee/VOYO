...
- searchByVibe: find tracks by vibe description (chill, hype, late-night, etc) — use for mood/feel requests
- searchByGenre: find tracks by genre name (afrobeats, amapiano, r&b, hip-hop, etc) — use when user mentions a specific genre
- setVolume: set volume 0–100 — use for "louder", "quieter", "mute", "full volume"
- cycleRepeat: cycle repeat mode (off/all/one) — use for "repeat this", "loop", "stop looping"
...
<tool_call><tool>searchByGenre</tool><genre>afrobeats</genre></tool_call>
<tool_call><tool>searchByVibe</tool><vibe>late night chill</vibe></tool_call>
...
Pattern: for genre requests → searchByGenre first; for vibe/mood requests → searchByVibe; then playTrack/addToQueue on returned IDs.
