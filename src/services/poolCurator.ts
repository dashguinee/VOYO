...
function buildSmartQueries(): string[] {
  ...
  if (lastTrack) {
    ...
    const GENRE_QUERIES: Record<string, string> = {
      ...
      afrofusion:    'afrofusion music',
      kizomba:       'kizomba latest',
      'bongo-flava': 'bongo flava hits',
      rumba:         'congolese rumba',
      soukous:       'soukous congolese',
      ndombolo:      'ndombolo music',
